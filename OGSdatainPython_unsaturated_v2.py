...
#        plt.ylim(-0.004,0)
    ...
    plt.figure()
    for j in range(len(Trial)):     
        df,  conctime, Velocity, Headinlettime = uta.calcconcmasstime(Trial[j], Het[j], Anis[j], gw, directory, fpre, fsuf, yin, yout, xleft, xright, vars, gvarnames)   
