...
def calcmassflux (Trial, Het, Anis, gw, directory, fpre, fsuf, yin, yout, xleft, xright, vars, gvarnames):
    vedge = 0.005
    velem = 0.01
    vbc = 0.3
    por = 0.2
...
def calcsum (Trial, Het, Anis, gw, directory, fpre, fsuf, yin, yout, xleft, xright, vars, gvarnames):
    vedge = 0.005
    velem = 0.01
    vbc = 0.3
    por = 0.2
